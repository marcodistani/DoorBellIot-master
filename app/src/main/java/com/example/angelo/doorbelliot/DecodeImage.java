...
/**
 * Created by marco on 08/05/2017.
 */
public class DecodeImage {
    ...
    public static void zoomImageFromThumb(final View thumbView, int imageResId, int mShortAnimationDuration,Animator mCurrentAnimator,View view) {
